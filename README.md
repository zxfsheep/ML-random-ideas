...
---
#### 1. [A simple way to find a good cross validation split](https://nbviewer.jupyter.org/github/zxfsheep/ML-random-ideas/blob/master/Find_best_split.ipynb)
...
#### 2. [Dealing with fragmented and nonuniform time series data](https://nbviewer.jupyter.org/github/zxfsheep/ML-random-ideas/blob/master/Dealing_with_messy_time_series_data.ipynb)
...
#### 4. [Ranking encoding](https://nbviewer.jupyter.org/github/zxfsheep/ML-random-ideas/blob/master/Ranking_encoding.ipynb)
